label w0_d2_LunchPythonC:
    ...
    show cpp_angry at right with easeinright
    ...
    hide cpp_angry
    show cpp_handhip_talk at right
    c "\"I don’t care, do whatever you want.\""

    hide cpp_handhip_talk
    show cpp_handhip_normal at right
    hide python_pocket
    show python_pocket_happy at left
    p "\"It’s settled then.\""
    ...
    c "\"Why not? Are you so stupid you don’t know how to cook?\""
    ...
    mc "\"I am from an area about 4 hours away from here, so I had to stay in a hotel.\""
    ...
    p "\"I've never been to Bytesborough before today.\""
    ...
    c "\"Classes haven’t started yet, so they have no reason to be here.\""
