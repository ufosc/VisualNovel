label w0_d2_LunchJava:
    ...
    js "\"No, it’s okay.\""
    js "\"I’m not mad.\""
    js "\"Like I said, it was a misunderstanding.\""
    ...
    hide js_normal
    show js_talk
    js "\"Oh no! Did you make it to orientation on time?\""
    hide js_talk
    show js_normal
    mc "\"No! But that wasn’t even the worst part.\""
    ...
    hide js_normal
    show js_talk
    js "\"Yeah, I LITERALLY experienced the same thing!\""
    ...
    mc "\"She was definitely older than us, and she seemed really knowledgeable.\""
    mc "\"She couldn't have been a student, she looked too old to be anywhere near our age.\""
    hide js_normal
    show js_talk
    js "\"Hmm, maybe-\""
    hide js_talk
