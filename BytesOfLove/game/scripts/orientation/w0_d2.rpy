label w0_d2:
    ...
    mc "{i}*You sit down at a table with 3 girls*{/i}"
    ...
    hide cpp_talk
    show cpp_normal
    mc "{i}*You obediently sit down (still flustered)*{/i}"
    ...
    js "I played varsity tennis in high school!"
    hide js_talk
    show js_smirk
    ...
    menu w0_d2_BreakoutResponse1:
        ...
        "Respond to Python":
            ...
            mc "And AI is a great field to make money in."
