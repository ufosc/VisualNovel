label w0_d1:
    ...
    mc "Man, I can't believe it, I'm really starting my first day at the University of Byteborough tomorrow."
    ...
    mc "I am super grateful my parents gave me a new car for college, I would be lost on where to go without it."
    ...
    label w0_d1_End:
        ...
        menu w0_d1_Valorant:
            ...
            "Gaming grind": 
                ...
                "*[mc] walks over to his bed and falls asleep immediately*"
            ...
            "Sleeping early":
                ...
                # Wanted to talk with the team about how we are doing the YouTube timelapse and
                # the picture of the mc passed out - Lazzy
